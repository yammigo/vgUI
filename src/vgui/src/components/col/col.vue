...
export default {
  ...
  computed: {
    ...
    styles() {
      ...
      if (typeof this.$parent.space == 'number' && this.$parent.space !== 0) {
      ...
      if (typeof this.$parent.spaceX == 'number' && this.$parent.spaceX !== 0) {
        style[`${styletype}Left`] = getHalf(this.$parent.spaceX, true)
        style[`${styletype}Right`] = getHalf(this.$parent.spaceX, false)
      }
      if (typeof this.$parent.spaceY == 'number' && this.$parent.spaceY !== 0) {
